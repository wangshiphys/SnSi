...
data_name_temp += "Phase12Line_t=-1.00_U={U:.2f}.npz"
...
for id in ids:
    ...
    # if id["amplitude"] == 0.00:
    #     label = "A = 1.00"
    # else:
    #     label = r"$A\in[{0:.2f}, {1:.2f})$".format(
    #         1 - id["amplitude"], 1 + id["amplitude"]
    #     )
    # ax.text(0, baseline, label, ha="center", va="bottom", fontsize=15)
    baseline += interval
